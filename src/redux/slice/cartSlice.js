  ...
  reducers: {
    ...
    DECREASE_CART(state,action){
      ...
      if(state.cartItems[productIndex].cartQuantity>1){
        ...
        toast.success(`${action.payload.name} removed to card`,{position: 'top-left'})
      }
      localStorage.setItem('cartItems',JSON.stringify(state.cartItems))
    },
...
export const {CALCULATE_TOTAL_QUANTITY,ADD_TO_CART,DECREASE_CART,REMOVE_FROM_CART,CLEAR_CART,CALCULATE_SUBTOTAL, SAVE_URL} = cartSlice.actions
